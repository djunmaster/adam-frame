...
public class LocalDateTimeUtil {
    ...
    public static List<LocalDateTime> getMonthWeekDayList(LocalDateTime date) {
        ...
        List<LocalDateTime> retList = Arrays.asList();
    ...
    public static List<LocalDateTime> getMonthDayList(LocalDateTime date) {
        ...
        ArrayList retList;
        for(retList = CollectionUtil.newArrayList(); !monthFirstDay.isAfter(monthLastDay); monthFirstDay = monthFirstDay.plusDays(1L)) {
